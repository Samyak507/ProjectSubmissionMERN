  ...
  return (
    ...
    <div className="wrapper">
        <div className="form-left">
            <h2 className="text-uppercase">Freaks Developers</h2>
            <p>
                Welcome to the <span style={{color:"#F45C84"}}>Freaks Developers</span> , we heartly welcomes you to become a member after registering in our organization.
            </p>
